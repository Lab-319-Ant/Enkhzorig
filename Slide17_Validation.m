%% ============================================================
%  СЛАЙД 17 — Бодит Туршилттай Баталгаажуулалт
...
% Слайд 17-оос авсан утгууд
rsrp_actual   = [22, 15, 18, 22, 18];   % Бодит туршилт (дБ)
rsrp_sim_slide= [21, 17, 18, 20, 19];   % Манай симуляц (дБ) — слайд
...
fprintf('=== Слайд 17: Баталгаажуулалт ===\n');
...
%% ── Дэд1: Слайд 17-тай яцагдсан Bar chart ───────────────────
ax1 = subplot(1,3,[1 2]);
...
bar(x,   rsrp_sim_slide, w, 'FaceColor',[0.85 0.35 0.10],'EdgeColor','none', ...
    'DisplayName','Манай симуляц (слайд)');
...
title({'Слайд 17: RSRP Gain — Бодит Туршилттай Харьцуулалт', ...
    'Олон Улсын 5G Туршилтуудын Баталгаажуулалт'}, ...
    'FontSize',12,'FontWeight','bold');
legend('Location','northeast','FontSize',9);
ylim([0 28]); yticks(0:3:28);
grid on; box on;

% ±2 дБ-ийн баталгаажуулалтын дүгнэлт
annotation('textbox',[0.08 0.04 0.55 0.08], ...
    'String', '✓ Симуляц нь бодит орчны туршилт ±2 дБ-ийн хязгаарт нийцэж байна', ...
    'BackgroundColor',[0.9 1 0.9],'EdgeColor',[0.2 0.7 0.2], ...
    'FontSize',10,'FontWeight','bold','Color',[0.1 0.5 0.15]);
