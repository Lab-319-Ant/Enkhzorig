...
%% ── 2. Фазын Нарийвчлалын Нөлөө ─────────────────────────────
% Фасын bit = {1,2,3,4,Continuous}
% SNR алдагдал: 1-bit тохируулгатай ideal-тай харьцуулсан алдагдал
% 3GPP-ийн загвар: SNR_loss ≈ -10*log10(sinc(1/2^b)^2) × M
...
% Оновчтой хэсгийн бүс тэмдэглэх
patch([50 60 60 50], [-2 -2 19 19], [0.2 0.85 0.3], ...
    'FaceAlpha',0.12,'EdgeColor',[0.2 0.85 0.3],'LineWidth',1.5);
text(55, 17.5, 'Оновчтой\nбүс', 'HorizontalAlignment','center', ...
    'FontSize',9,'Color',[0.1 0.6 0.2],'FontWeight','bold');

% Тайлбар шугамууд
xline(50, ':', 'Color',[0.2 0.7 0.3],'LineWidth',1.2);
xline(60, ':', 'Color',[0.2 0.7 0.3],'LineWidth',1.2);
...
% Дүгнэлт хайрцаг
text(100, 7.5, {'Optimal point:', 'd_{BR} ≈ 0.33–0.40 × d_{нийт}', '≈ 50–60 м'}, ...
    'FontSize',9,'BackgroundColor',[0.95 1 0.95],'EdgeColor',[0.3 0.7 0.3], ...
...
% Дүгнэлт
text(3, 3.8, {'3-bit: практик хэрэглээнд', 'хангалттай сайн гүйцэтгэл'}, ...
    'HorizontalAlignment','center','FontSize',9, ...
    'BackgroundColor',[0.9 1 0.9],'EdgeColor',[0.3 0.7 0.3]);

sgtitle({'Слайд 15: BS-RIS Байршлын Оновчлол ба Фазын Нарийвчлал', ...
